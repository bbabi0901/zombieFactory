...
contract("ZombieFactory", async (accounts) => {
  ...
  describe("Zombie generated by 'create'", () => {
    it("두 좀비의 주소가 달라야 합니다.", async () => {
      ...
      expect(zombie1Addr).to.equal(zombie2Addr);
    });
  });
...
//     this.ZombieFactory = await ethers.getContractFactory("ZombieFactory");
//     this.zombieFactory = await this.ZombieFactory.deploy();
//     await this.zombieFactory.deployed();
//     console.log("Deployed Factory: ", this.zombieFactory.address);

//     this.ZombieTemp = await ethers.getContractFactory("ZombieTemp");
//     this.zombieTemp = await this.ZombieTemp.deploy();
//     await this.zombieTemp.deployed();
//     console.log("Deployed ZombieTemp: ", this.zombieTemp.address);
...
//   describe("Zombie generated by 'create'", () => {
//     it("두 좀비의 주소가 달라야 합니다.", async () => {
//       let tx = await this.zombieFactory.createRandomZombie(this.name1);
//       // console.log(tx);
//       /*
...
//       console.log(receipt);
//       const abi = ["event Created(address zombie, uint dna)"];
//       const eventData = receipt.events[0].data;
//       let iface = new ethers.utils.Interface(abi);
//       let res = iface.parseLog(eventData);
//       console.log(res);

//       var { zombie, dna } = tx.logs[0].args;
//       const zombie1Addr = zombie;
//       const zombie1 = await this.Zombie.at(zombie1Addr);
//       let name = await zombie1.name();
//       console.log("Zombie generated:", zombie1Addr, name, +dna);

//       tx = await this.zombieFactory.createRandomZombie(this.name2);
//       var { zombie, dna } = tx.logs[0].args;
//       const zombie2Addr = zombie;
//       const zombie2 = await this.Zombie.at(zombie2Addr);
//       name = await zombie2.name();
//       console.log("Zombie generated:", zombie2Addr, name, +dna);

//       // expect(zombie1Addr).to.equal(zombie2Addr);
//       should.not.equal(zombie1Addr, zombie2Addr);
//     });
//   });
//   /*
//   describe("Zombie generated by 'create2'", () => {
